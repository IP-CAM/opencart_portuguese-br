...
$_['tab_update_v1']						= 'fácil atualizador';
$_['tab_update_v2']						= 'legado atualizador';
$_['tab_patch']							= 'Caminho';
...
$_['text_patch_description']			= 'Se você carregou os arquivos de atualização manualmente, você precisa executar o patch para concluir a atualização';
...
$_['text_action_warning']				= 'Esta ação é perigoso, é protegido por senha.';
$_['text_check_new']					= 'Verificar a versão mais recente';
$_['text_downloading']					= 'Download de arquivos de atualização';
$_['text_extracting']					= 'Extraindo arquivos';
$_['text_running_patch']				= 'Executando arquivos de patch';
$_['text_fail_patch']					= 'Não foi possível extrair arquivos de atualização';
$_['text_updated_ok']					= 'Atualização completa!';
$_['text_check_server']					= 'Verificando requisitos do servidor';
$_['text_version_ok']					= 'Software já está atualizado, versão instalada é ';
$_['text_remove_files']					= 'Removendo arquivos não é mais necessário';
$_['text_confirm_backup']				= 'Verifique se você tem um backup completo antes de continuar';
...
$_['entry_empty_data']					= 'Armazenar dados vazio?';
$_['entry_password_prompt']				= 'Por favor, insira os dados limpar senha';
$_['entry_update']						= 'Facil atualização em 1 Click';
...
$_['error_mkdir']						= 'Função PHP mkdir estiver desativado, entre em contato com o seu host';
$_['error_file_delete']					= 'Não foi possível remover esses arquivos, você deve excluí-los manualmente';
$_['error_mcrypt']            			= 'PHP função "mcrypt_encrypt" não está habilitado. Contacte o seu provedor de hospedagem.';
$_['error_mbstring']               		= 'Biblioteca PHP "cordas mb" não está habilitado. Contacte o seu provedor de hospedagem.';
$_['error_ftpconnect']             		= 'Funções de FTP PHP não estão habilitados. Contacte o seu provedor de hospedagem.';
$_['error_oc_version']             		= 'Sua versão do OpenCart não é testado para trabalhar com este módulo. Você pode ter problemas.';
$_['error_fopen']             			= 'PHP função "fopen" é desativado pelo seu anfitrião - você não será capaz de importar imagens ao importar produtos';
...
$_['help_easy_update']					= 'Clique em Atualizar para instalar a última versão do OpenBay Pro automaticamente';
$_['help_patch']						= 'Clique para executar os scripts de patch';